...
import { getCheatSessionMessages, sendCheatModeMessage } from "../../lib/ai/cheatMode";
...
/**
 * Один конкретный чат режима "Срочно списать". Здесь нет кнопки "Я ничего не понял"
 ...
 */
export default function CheatModeChatScreen() {
  ...
  useEffect(() => {
    if (!sessionId) return;
    const history = getCheatSessionMessages(sessionId);
    setMessages(history);
